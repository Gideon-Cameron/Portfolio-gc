const Hero = () => {
    return (
      <section className="min-h-screen flex flex-col justify-center px-6 md:px-12 max-w-4xl mx-auto">
        ...
        <h1 className="text-5xl sm:text-6xl md:text-7xl font-bold text-[#111827] dark:text-[#ccd6f6] mb-2 leading-tight">
          Gideon Cameron.
        </h1>
  
        <h2 className="text-4xl sm:text-5xl md:text-6xl font-semibold text-[#4b5563] dark:text-[#8892b0] mb-6 leading-tight">
